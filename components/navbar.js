...
export default function Navbar() {
    ...
    return (
        ...
        <nav className="nav_container flex justify-end mx-10 md:mx-24 lg:mx-32 xl:mx-48 2xl:mx-80 my-8 text-xl space-x-6 md:space-x-10 lg:space-x-14 text-base uppercase">
