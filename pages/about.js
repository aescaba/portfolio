    ...
    <div class="">
      ...
      <div class="flex flex-col-reverse lg:flex-row">
        ...
        <div class="max-w-sm mt-16 pb-24 lg:pb-0 lg:mt-0 lg:mr-20 xl:mr-24 place-self-center lg:place-self-auto">
          <Image class="" src="/portfolio/public/images/apl.png" alt="Photo of Amanda holding an apple in front of an apple tree" width={1536} height={2048}/>
        </div>
        ...
        <div class="space-y-4 font-light">
          ...
          passionate about <span class="font-semibold">sharing and preserving culture, uplifting marginalized voices, and building community,</span> especially through storytelling.</p>
